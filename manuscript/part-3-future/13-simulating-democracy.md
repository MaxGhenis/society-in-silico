...
**The ACA enrollment surprises.** As Chapter 4 described, CBO correctly predicted total ACA coverage gains but badly missed the composition—overestimating exchange enrollment by half and underestimating Medicaid enrollment. Voters who opposed the ACA based on predicted exchange market disruption experienced a reality that was quite different. Those who supported it for Medicaid expansion saw larger-than-expected gains. In both cases, the gap between voter perceptions of the law's effects and its actual effects persisted for years. A 2017 survey found that 35% of Americans didn't know the ACA and "Obamacare" were the same law—a failure of basic information transmission that no amount of simulation can fix, but that illustrates how far actual voter knowledge falls from the idealized version.
