...
Researchers had seen it coming. In 2023, a Johns Hopkins and Maryland team found GPT-4 answered only 67 percent of true-or-false tax questions correctly — better than a coin, useless for a filing [@blairstanek2023gpt4tax]. And it has not aged away. By mid-2026, PolicyEngine's own benchmark, PolicyBench, was scoring twenty frontier and open models on complete household tax-and-benefit calculations; the best model still got roughly one in six households wrong by more than a dollar, and most missed a quarter or more [@policybench2026]. These are not rounding slips. A miss means the model told a family the wrong Medicaid eligibility or the wrong food-assistance amount.
