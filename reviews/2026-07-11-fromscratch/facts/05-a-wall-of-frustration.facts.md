...
- Footnote/disclosure: as of July 2026, Nikhil Woodruff serves in the UK government at 10 Downing Street [VERIFY with Nikhil: role wording]. Noted as a disclosure because much of the book touches UK policy and the institutions that model it. (Enriched with the public trace per research/part2-verification.md: PolicyEngine's own post describes Nikhil as an "Innovation Fellow with 10DS" — the No 10 Downing Street data-science team — for roughly six months from summer 2025, building a `10ds-microsim` package on PolicyEngine [@policyengine2026downingstreet]. Keep the [VERIFY with Nikhil: role wording] marker: the current-status wording still needs Nikhil's confirmation.)
...
- UBI Center analysis of Yang's proposal (data content): showed a 74 percent reduction in poverty, but also that the plan would cost about $2.8 trillion a year while his five proposed taxes would raise only $1.2 trillion, leaving a $1.6 trillion gap [@ubicenter2019freedomdividend]. (Marker resolved per research/part2-verification.md: the UBI Center's "Distributional analysis of Andrew Yang's Freedom Dividend," 24 June 2019, confirms $12,000/yr to 236M adults = $2.8T gross, new tax revenue $1.2T leaving $1.4T unfunded, and poverty −74% (7.3%→1.9%); the "$1.6 trillion gap" is $2.8T gross minus $1.2T raised.)
- UBI Center carbon-dividend work (data content): a £100-per-tonne UK carbon tax would cut poverty by 14 percent and deep child poverty by 33 percent [@ubicenter2022ukcarbon]. (Marker resolved per research/part2-verification.md: "The progressivity of a UK carbon dividend," 23 April 2022 — £100/tonne cuts poverty 14%, bottom decile +6.2%, top decile −2.1%, Gini −3.4%; the deep-child-poverty −33% figure is the source's own summary, reported from the report's charts. A US companion at $100/ton gives poverty −10%, deep child poverty −27%.)
...
Nikhil disclosure footnote (carry with its [VERIFY] marker): "As of July 2026, Nikhil Woodruff serves in the UK government at 10 Downing Street [VERIFY with Nikhil: role wording]. I note it here as a disclosure—much of what follows in this book touches UK policy and the institutions that model it—and because the shape of the thing is hard to improve on: the co-founder I recruited from a subreddit now works inside the government whose analytical machinery these tools were built to open up."
  ...
  (Editorial note, do not overwrite the verbatim footnote: the public trace per research/part2-verification.md is an "Innovation Fellow with 10DS" fellowship, ~six months from summer 2025, building `10ds-microsim` [@policyengine2026downingstreet]. If the rewrite tightens the wording, "Innovation Fellow with 10DS" is the accurate, public phrasing — but the [VERIFY with Nikhil: role wording] marker STAYS, because the current-status "serves … as of July 2026" claim still needs Nikhil's confirmation.)
...
- **Disclosure to carry.** The Nikhil Woodruff / 10 Downing Street footnote (July 2026) with its [VERIFY with Nikhil: role wording] marker — a deliberate disclosure, not to be dropped. Consistent with the project rule to disclose Nikhil's No. 10 role in UK-policy contexts. Public trace to enrich with (marker still stays): PolicyEngine's post describes an "Innovation Fellow with 10DS" role, ~six months from summer 2025, building `10ds-microsim` [@policyengine2026downingstreet].
