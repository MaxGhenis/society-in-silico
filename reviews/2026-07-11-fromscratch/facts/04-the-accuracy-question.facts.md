...
- Model disagreement on TCJA (data content): four institutions scored the bill a factor of five apart — JCT static $1.46 trillion revenue loss; Penn Wharton $1.9-to-$2.2-trillion dynamic debt range; the Tax Foundation's far more optimistic $448 billion; the Tax Policy Center's distributional work broadly consistent with the JCT on revenue.
...
- **The TCJA framing scene.** 2017: JCT scores TCJA at $1.46T over ten years; Penn Wharton at $1.9–2.2T dynamic debt; Republicans dispute both; supply-siders predict self-funding growth; that prediction fails; the models were "approximately right." Sets the whole chapter's stakes.
