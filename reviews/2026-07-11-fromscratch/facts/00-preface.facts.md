...
- Disclosure (carried in a footnote): as of July 2026, Nikhil Woodruff serves in the UK government at 10 Downing Street. [VERIFY with Nikhil: role wording] — the footnote flags that where the book discusses UK institutions evaluating tools Nikhil helped build, this should be read with that in mind. (Enriched with the public trace per research/part2-verification.md: PolicyEngine's own post describes Nikhil as having served as an "Innovation Fellow with 10DS" — the No 10 Downing Street data-science team — for roughly six months from summer 2025, building a `10ds-microsim` package on PolicyEngine that was "intensively validated against external projections and official forecasts" [@policyengine2026downingstreet]. The [VERIFY with Nikhil: role wording] marker STAYS: the exact current-status wording "as of July 2026" still needs Nikhil's confirmation, since the public trace is a ~six-month fellowship beginning summer 2025, clearly labeled experimental analysis rather than a permanent government post.)
