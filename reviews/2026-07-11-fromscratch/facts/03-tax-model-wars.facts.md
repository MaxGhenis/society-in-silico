...
- (new — primary source) The four founders were banker Will Hopper, investment-trust manager Bob Buist, stockbroker Nils Taube, and tax consultant John Chown; the idea was provoked by the opacity of the 1965 Finance Act (which introduced capital gains tax) and decided over a dinner on 30 July 1968 at the Stella Alpina restaurant in London, with the IFS incorporated the following year [@ifs2024history].
...
- Section 6103 of the Internal Revenue Code forbids disclosure of individual tax-return information, with a narrow set of exceptions; under Section 6103(f), the Joint Committee on Taxation (and the tax-writing committees) have statutory access to the returns themselves, and Treasury/OTA access is inherent for tax administration (§6103(h)). External researchers do not. (Subsection corrected from (l) to (f) per primary source — see research/part1-verification.md correction #4: §6103(l) governs disclosure for purposes *other than* tax administration, e.g. to SSA/HHS/state agencies, not JCT access.)
...
- In 2002, Gene Steuerle and Len Burman founded the Tax Policy Center as a joint venture of the Urban Institute and the Brookings Institution [@tpc2024model]; TPC's own history names a third co-founder, William (Bill) Gale. Steuerle had helped build the official models at Treasury; Burman at CBO and Treasury. (Third founder Gale added per primary source — see research/part1-verification.md #5.)
...
- TCJA scores (data content): JCT's static score put the ten-year cost at $1.46 trillion [@jct2017budget]; its dynamic score came in at about $1.07 trillion, reflecting roughly $385 billion of *net* deficit reduction through faster growth (≈$451 billion more revenue minus ≈$66 billion more interest spending) — a ~27 percent reduction in cost [@jct2017macro]. (Marker resolved: static = JCX-67-17, dynamic = JCX-69-17; "$385 billion" is the net deficit reduction, not gross revenue — see research/part1-verification.md #5.)
- Penn Wharton, running the feedback through its own model, put the TCJA dynamic cost higher, in the range of $1.9 to $2.2 trillion added to federal debt, judging the growth effects modest [@pwbm2017tcja]. [Amended 2026-07-12: PWBM's conference-committee analysis (12/18/2017) states federal debt increases $1.9 to $2.2 trillion by 2027 on a dynamic basis — the manuscript's $1.9–2.2 debt framing is correct; $1.8 was wrong.]
